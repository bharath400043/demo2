...
'''
Desktop, Web Application Enterprise Application
Web Application :  hdfc icici paytm
=================
  UI           ---   Backend                         --- Database
  ==========================================================================
  HTML               Python(Flask/Django)               Postgresql* (RDBMS*)
  JavaScript         Java  (Spring,Struts,JSF)          MySQL*
  CSS                .Net                               Sqlite
  Angular                                               Oracle/SQL Server
...
try:
    ...
    # Step3 : Prepare SQL Query
    query = "create table DEPT(deptno INT,dname TEXT,loc text)"
    # Step4 : Execute SQL query
    cur.execute(query)
    conn.commit()
