...
for each in list1:
    print(each)
'''
1. On list object list1, __iter__() / iter() method will be called.We will get iterator object
2. On iterator object __next__() / next()  method will be called,
