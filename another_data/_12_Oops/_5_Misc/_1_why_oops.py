...
Why oops : To overcome drawback of direct state initialization
...
res = obj.get_length()
print("4. OOPs      : Length of list : ",res)
...
print("4. OOPs      : Length of list : ",ListLength.get_length())
