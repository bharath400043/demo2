...
class Employee:
    # STATE
    def __init__(self, eid, name, sal):   # Fields/Instance variables
        self.eid = eid                    # State initialization
        self.name = name
        self.sal = sal
...
# madhu ==>          object
madhu = Employee(100,'Madhu Nettem',25000) # Object creation   ==> Equals to 11,12,13 lines
