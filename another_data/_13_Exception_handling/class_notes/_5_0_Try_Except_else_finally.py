...
try:  
    ...
    '''
    2 ---> except ZeroDivisionError as zde:
    3 ---> except ArithmeticError/Exception as ae:
    '''
except:
    print("In EXCEPT :: You are trying to divide by Zero.Pleaes enter value other than 0 : ",ae)
else:  
